...
import { Music, Shield, CheckCircle, LogOut, ArrowRight, Sparkles, TrendingUp, Clock, Award, Info, Swords, Users, Trophy } from 'lucide-react';
      ...
      <div className="relative z-10">
        ...
        <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 border-t border-white/5">
          <div className="max-w-4xl mx-auto">
            <div className="relative overflow-hidden bg-gradient-to-br from-purple-500/10 via-pink-500/10 to-purple-500/10 border border-purple-500/20 rounded-3xl p-8 sm:p-12">
              ...
              <div className="relative z-10">
                <div className="text-center mb-8">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 mb-6 bg-purple-500/20 border border-purple-500/30 rounded-full">
                    <Swords className="text-purple-400" size={14} />
                    <span className="text-sm text-purple-300 font-medium">New Feature!</span>
                  </div>
                  ...
                  <p className="text-lg text-white/70 mb-8 max-w-2xl mx-auto">
                    Challenge your fellow ARMYs in real-time quiz battles! Compete with up to 5 players,
                    answer 15 BTS questions, and prove who&apos;s the ultimate ARMY.
                  </p>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                    <div className="p-4 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
                      ...
                      <div className="text-white font-semibold mb-1">Up to 5 Players</div>
                      <div className="text-sm text-white/60">Battle with friends</div>
                    </div>
                    <div className="p-4 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
                      <Trophy className="text-pink-400 mx-auto mb-2" size={24} />
                      <div className="text-white font-semibold mb-1">15 Questions</div>
                      <div className="text-sm text-white/60">Test your knowledge</div>
                    </div>
                    <div className="p-4 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
                      <Clock className="text-purple-400 mx-auto mb-2" size={24} />
                      <div className="text-white font-semibold mb-1">150 Seconds</div>
                      <div className="text-sm text-white/60">Fast-paced action</div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-xl text-white font-bold text-lg transition-all hover:scale-105 shadow-lg shadow-purple-500/25"
                  >
                    <Swords size={20} />
                    Start Quiz Battle
                    <ArrowRight size={20} />
