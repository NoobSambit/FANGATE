              ...
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-white/10 border border-white/20 hover:border-purple-500/50 hover:bg-white/15 text-white font-semibold rounded-xl transition-all"
                  >
                    <Award size={20} />
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-xl transition-all shadow-lg hover:shadow-purple-500/50"
                  >
                    <Share2 size={20} />
